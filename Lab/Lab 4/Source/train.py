...
# Data loading params
tf.flags.DEFINE_string("pos_dir", "data/ecohoteldata.txt", "Path of positive data")
tf.flags.DEFINE_string("neg_dir", "data/sentimentlabel.txt", "Path of negative data")
...
def train():
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            train_op = tf.train.AdagradOptimizer(FLAGS.learning_rate).minimize(rnn.loss, global_step=global_step)
